...
<section id="how">
  <div class="section-inner">
    <p class="eyebrow">Who you answer for</p>
    <h2 class="section-title">The responsibility is yours. The follow-through is ours.</h2>
    <p class="section-sub">Healthcare fails in the gaps between employer, doctor, scheme and member. Whichever of these you are, our job is to hand you the plan, the codes and the schedule that let you deliver.</p>
...
<section><div class="section-inner">
  <div class="grid grid-2">
    ...
    <div class="card"><h3>Leadership — Dr A Nazo, Founder &amp; Principal Practitioner</h3>
      <p>Dr Nazo built Primum on a conviction formed in Eastern Cape communities where care too often arrived late or not at all: <b>the people responsible for others' health already do the hard part</b> — the employer protecting a workforce, the practice carrying a patient community, the funder stretching every benefit rand, the member facing a diagnosis. What fails them is never commitment; it's coordination. Primum exists to supply it — the plan, the codes and the follow-through that turn responsibility into results.</p>
